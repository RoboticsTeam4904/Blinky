...
public class RobotMap {
    ...
    public static class SplineAutoConstants {
        ...
        public static final AutoConstants autoConstants = new AutoConstants(kMaxSpeedMetersPerSecond,
    ...
    public RobotMap() {
        ...
        // Component.rightWheelEncoder); // TODO: Update for cancoders
        // Wheels

        Component.rightWheelA = new Motor("rightWheelA", false,
                new CANTalonFX(Port.CANMotor.rightDriveA, NeutralMode.Coast));
        Component.rightWheelB = new Motor("rightWheelB", false,
                new CANTalonFX(Port.CANMotor.rightDriveB, NeutralMode.Coast));
        Component.leftWheelA = new Motor("leftWheelA", true,
                new CANTalonFX(Port.CANMotor.leftDriveA, NeutralMode.Coast));
        Component.leftWheelB = new Motor("leftWheelB", true,
                new CANTalonFX(Port.CANMotor.leftDriveB, NeutralMode.Coast));
        ...
        Component.nikhilDrive = new SensorDrive(Component.chassis,
        SplineAutoConstants.autoConstants, SplineDriveConstants.driveConstants,
        Component.leftWheelEncoder, Component.rightWheelEncoder, Component.navx);
    }
}
